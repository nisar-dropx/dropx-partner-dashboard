...
export const accessPages = [
  ...
  { code: "contractors", name: "Independent Contractors", sort_order: 24 },
  { code: "workers", name: "Helpers", sort_order: 25 },
  { code: "vendors", name: "Vendors", sort_order: 26 },
  ...
  { code: "ops_location_mail", name: "Location Mail", sort_order: 85 },
