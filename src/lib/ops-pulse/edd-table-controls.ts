...
export const EDD_POSITIONS = [["atStation", "Pending"], ["observedAtStation", "At station · INDUCTED / RECEIVED"], ["onRoad", "On road"], ["delivered", "Delivered"], ["hfr", "HFR · one prior-day attempt"], ["hcr", "HCR · two or more prior attempts"], ["rejected", "Rejected"], ["returningToFc", "In transit to FC"], ["attempted", "Attempted / returned today"], ["unverified", "Needs evidence check"], ["other", "Other statuses"], ["all", "All positions"]] as const;
