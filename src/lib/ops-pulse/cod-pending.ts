...
export type PendingSlip = { id:string; location_id:string|null; deposit_date:string|null; cod_period_from:string|null; cod_period_to:string|null; cod_date:string|null; remittance_code?:string|null; reference_no:string|null; deposited_amount:number|string|null; validated_amount:number|string|null; validation_status:string; ai_status?:string|null; ai_summary?:string|null; proof_checked_at?:string|null; last_updater_name?:string|null; remarks:string|null; validation_remarks:string|null; submitter_name:string|null; created_at:string; attachments:unknown; deposit_slip_attachments:unknown };
