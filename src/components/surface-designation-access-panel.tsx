...
export function SurfaceDesignationAccessPanel({
  ...
  return <section className="panel">
    ...
    <div className="panel-head" style={{ borderTop: "1px solid var(--border)" }}><div><h3>Location Account</h3><p className="subtle">Station mailbox access is granted only from the main Dashboard. Configure here which {title.replace(" designation access", "")} menus those mailboxes can use.</p></div></div>
