...
type RegisterCategory = "contractors" | "helpers";
...
export function WorkForceRegisterCategoryPage({ category, searchParams }: { category: RegisterCategory; searchParams?: WorkForceRegisterSearchParams }) {
  ...
  return (
    <FieldExecutivePageContent
      ...
      notice={searchParams?.notice} pageCode="contractors"
      pageSubtitle="Onboard and maintain independent contractors and helpers. Only OPS-enabled designations are available."
