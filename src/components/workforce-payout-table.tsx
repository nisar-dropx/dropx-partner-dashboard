...
export function WorkforcePayoutTable({ rows }: { rows: WorkforcePayoutRow[] }) {
  ...
  function exportRows() {
    ...
    const columns = ["DropX ID","Registered Worker","Provider Member","Provider Member ID","Location Code","Provider","Model","Payment Method",...productionHeaders,"Base Amount","Additional Payments","Gross Payment",...deductionHeaders,"Gross Deductions","Net Pay","PAN-Aadhaar Status","Status"];
