...
function MultiFilter({ label, values, selected, setSelected }: { label: string; values: string[]; selected: string[]; setSelected: (values: string[]) => void }) {
  ...
  return <div className="bulk-multi-filter all-people-filter" ref={rootRef}>
