...
const opsGroups: PermissionGroup[] = [
  ...
  { key: "operations", label: "Operations", codes: ["daily_submission", "cod_executive_reconciliation", "cod_submission", "cod_validation", "cod_reports", "cod_portal_checks", "cod_cash_in_associate", "edd_dashboard"], hiddenCodes: ["cod"] },
  { key: "business_documents", label: "Business Documents", codes: ["business_documents"] },
