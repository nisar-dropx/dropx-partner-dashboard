...
export function PerformanceCarriedActions({
  ...
  return <ReviewDetails className="review-followups">
    <summary>
      <span>
    ...
    <p className="review-followups-guide">
      Today’s uploaded Amazon metrics appear in the <strong>Performance scorecard</strong> above.
    ...
    {openItems.map(item=>{
      ...
      return <ReviewDetails key={item.id}>
        <summary>
          <span>
