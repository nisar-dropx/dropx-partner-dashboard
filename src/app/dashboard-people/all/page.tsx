...
const sources = [
  ...
  { categoryCode: "workers", category: "Helpers", pageCode: "workers", basePath: "/workers", table: "workers", codeField: "dropx_id", statusField: "onboarding_status", employeeDesignation: false }
] as const;
