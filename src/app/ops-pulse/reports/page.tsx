...
export default async function OpsReportsPage() {
  const authorization = await requirePagePermission("reports", "access");
  ...
  return <AppShell active="Reports" pageCode="reports"><div className="ops-command-center ops-reports-workspace">
