        ...
        {!workerConfigured ? (
          ...
          <section className="panel message-panel error">
            <div className="panel-body">
              ...
              <p className="subtle" style={{ marginTop: 6 }}>
                {stationCode ? (
                  <>{stationCode} isn&apos;t in your assigned stations. <Link href="/edd" prefetch={false}>Go back to All stations</Link> to pick one you have access to.</>
                ) : (
                  <>No station code was given. <Link href="/edd" prefetch={false}>Go back to All stations</Link>.</>
                )}
              </p>
            </div>
          </section>
