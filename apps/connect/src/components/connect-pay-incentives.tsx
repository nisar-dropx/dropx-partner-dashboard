...
export function ConnectPayIncentives({incentives}:{incentives:OwnIncentiveSummary}){
 return <section className={`dx-dashboard-card ${styles.card}`} aria-label="Production incentive estimate">
  ...
  <p className={styles.note}>Daily thresholds and caps combine your eligible provider IDs. This is an estimate, not payment confirmation. This calculation excludes referral rewards and pooled-MG supplements; separately approved additions appear under adjustments.</p>
 </section>;
}
