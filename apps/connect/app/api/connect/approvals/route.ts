...
export async function GET(request: Request) {
  try {
    ...
    return NextResponse.json({ scope, leaveApprovals, locationSupportPackages, attendanceApprovals, attendanceHrApprovals, rosterApprovals }, { headers: { "Cache-Control": "private, no-store" } });
  } catch (error) {
