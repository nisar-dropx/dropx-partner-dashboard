...
const checks = [
  ...
  [route.includes("stationSameDesignationFlags") && route.includes("sameStationDesignation") && route.includes("Choose a colleague with the same designation.") && route.includes("isHeadOfficeLocation"), "station working swaps can still require the same designation"],
  [route.includes("involvesWeekOff") && route.includes("no_working_colleagues") && route.includes("Week-off ↔ working"), "week-off swaps skip station designation limits and explain when nobody is working"],
