...
const checks = [
  ...
  [route.includes("assertSwapBeforeCutoff(requester, partner") && route.includes("isRosterChangePastDeadline") && route.includes("rosterChangeDeadlineMessage"), "swap cutoff uses previous-day 2:00 PM IST deadline"],
  [component.includes("rosterChangeDeadlineShortLabel") && component.includes('"No valid swap"') && component.includes("Only different rosters can be exchanged."), "unavailable swap days explain the eligibility and 2PM lock rules"],
