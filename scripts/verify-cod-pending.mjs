...
assert.equal(digest.buildCodDigestMessages(rows,{...source,stations:[]},recipients,date,'morning',evening.subject).length,0,'Resolved recipients get no unnecessary reminder');
