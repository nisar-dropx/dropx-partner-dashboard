...
const sql=read("supabase/migrations/20260909185756_ops_unplanned_leave_readonly.sql");
...
console.log("PASS: dates, hierarchy drill-down, scope rejection, filters/export parity, no-store, server-only auth and read-only contract.");
