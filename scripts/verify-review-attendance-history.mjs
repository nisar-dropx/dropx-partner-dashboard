...
const rosterPlanPreference=compile("src/lib/roster-plan-preference.ts");
const loader=compile("src/lib/ops-pulse/review-attendance-history-data.ts",{"server-only":{},"@/lib/supabase-admin":{supabaseAdmin:db},"./review-attendance-history":logic,"./review-operations-data":{loadReviewUtrDiscipline:async()=>({discipline:{rows:[{id:"employee:a",name:"Arjun",code:"D1",role:"TL"}]},error:null})},"@/lib/roster-plan-preference":rosterPlanPreference});
