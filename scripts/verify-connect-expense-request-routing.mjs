...
const checks = [
  ...
  [resolver.includes("resolveFinanceHeadApprover") && resolver.includes("resolveCompanyDesignationApprover"), "finance head and managing partner are collected as additional parallel pre-request approvers"],
