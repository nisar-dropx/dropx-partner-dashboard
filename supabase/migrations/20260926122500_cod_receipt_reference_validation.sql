...
create or replace function public.claim_cod_proof_check() returns setof public.cod_submissions language plpgsql security invoker set search_path=public as $$
begin return;end $$;
...
update public.cod_submissions set ai_status='Validation pending',ai_summary=null,ai_result='{}',proof_check_token=null,proof_check_started_at=null,proof_checked_at=null,proof_check_attempts=0
 where ai_result->>'policy_version' is distinct from '2';
create function public.claim_cod_proof_check_v2() returns setof public.cod_submissions language plpgsql security invoker set search_path=public as $$
begin
...
revoke all on function public.claim_cod_proof_check_v2() from public,anon,authenticated;
grant execute on function public.claim_cod_proof_check_v2() to service_role;
