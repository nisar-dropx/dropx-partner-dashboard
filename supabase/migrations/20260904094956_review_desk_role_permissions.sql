...
select r.company_id,r.id,p.id,true,
  r.code not in ('LOCATION','OPERATIONS_LOCATION','OPERATIONS_TL','OPERATIONS_ATL'),true,now(),now()
...
where r.is_active and r.code in ('LOCATION','OPERATIONS_LOCATION','OPERATIONS_TL','OPERATIONS_ATL','PROGRAM_HEAD','OPERATIONS_PROGRAM_HEAD','OPERATIONS_PGM',
  'CLUSTER_HEAD','REGIONAL_HEAD','NATIONAL_HEAD','OPERATIONS_CLM','OPERATIONS_AOM','OPERATIONS_NH','OPERATIONS_CLUSTER_HEAD','OPERATIONS_REGIONAL_HEAD','OPERATIONS_NATIONAL_HEAD')
